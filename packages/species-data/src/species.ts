...
export const SPECIES = {
  ...
  // --- M1 roster wave 2: to twelve (Jurassic apex, whip-tail, robust duckbill) -
  allosaurus: {
    id: 'allosaurus',
    name: 'Allosaurus',
    archetype: 'theropod',
    ...
    // Leaner and more horizontal than T-Rex, with a longer low skull and
    // substantial forelimbs — the medium Jurassic pursuit predator.
    morph: {
      hipY: 288,
      shoulderRise: 16,
      bodyLen: 148,
    ...
    features: [{ kind: 'teeth', slot: 'head' }],
    syllables: { prefix: 'Allo', duo: 'allus', mid: 'allo', suffix: 'saurus' },
    stats: { attack: 84, defense: 40, speed: 66, brains: 52 },
    uiColor: '#b06a3e',
  },
  ...
  diplodocus: {
    ...
    // The counterpoint to Brachiosaurus: a very long neck held low and level, a
    // near-horizontal back, and an extreme whip tail. Stress-tests the tail
    // range the way Brachiosaurus stresses the neck.
    morph: {
      hipY: 300,
      shoulderRise: -8,
      bodyLen: 172,
    ...
    features: [],
    syllables: { prefix: 'Diplo', duo: 'docus', mid: 'diplo', suffix: 'docus' },
    stats: { attack: 28, defense: 74, speed: 26, brains: 26 },
    uiColor: '#5d7f86',
  },
  ...
  iguanodon: {
    ...
    // Robust, heavier ornithopod that browsed on all fours — longer forelimbs
    // that reach the ground and a broad snout, distinct from the bipedal,
    ...
    features: [],
    syllables: { prefix: 'Iguano', duo: 'iguanon', mid: 'iguano', suffix: 'odon' },
    stats: { attack: 34, defense: 56, speed: 50, brains: 44 },
    uiColor: '#94804a',
  },
