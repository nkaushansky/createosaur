...
export const dinosaurDatabase: DinosaurSpecies[] = [
  ...
  // Additional Triassic Period Species
  {
    id: "herrerasaurus",
    name: "Herrerasaurus",
    ...
    size: "Medium",
    habitat: "River valleys",
    traits: ["Early theropod", "Bipedal stance", "Sharp claws", "Primitive features"],
    description: "One of the earliest dinosaurs, bridging the gap to reptiles",
    lengthMeters: 4.5,
    weightKg: 350,
    discoveryLocation: "Argentina"
  },

  // Additional Jurassic Period Species
  {
    id: "ceratosaurus",
    name: "Ceratosaurus",
    ...
    diet: "Carnivore",
    size: "Large",
    habitat: "Floodplains and rivers",
    traits: ["Nasal horn", "Powerful jaws", "Distinctive skull", "Semi-aquatic"],
    description: "Horned predator that may have been semi-aquatic",
    lengthMeters: 8.5,
    weightKg: 2000,
    discoveryLocation: "Colorado, USA"
  },
  {
    ...
    size: "Medium",
    habitat: "Woodlands",
    traits: ["Back spikes and plates", "Shoulder spikes", "Defensive armor", "Small head"],
    description: "African stegosaur with impressive defensive spikes",
    lengthMeters: 5,
    weightKg: 700,
    discoveryLocation: "Tanzania"
  },

  // Additional Cretaceous Period Species
  {
    id: "deinonychus",
    name: "Deinonychus",
    ...
    size: "Medium",
    habitat: "Forests and plains",
    traits: ["Sickle claw", "Pack hunter", "High intelligence", "Warm-blooded"],
    description: "Revolutionary discovery that changed how we view dinosaurs",
    lengthMeters: 3.5,
    weightKg: 75,
    discoveryLocation: "Montana, USA"
  },
  {
    ...
    size: "Large",
    habitat: "Coastal plains",
    traits: ["Good mother", "Colonial nesting", "Crest on head", "Social behavior"],
    description: "Good mother lizard known for elaborate parental care",
    lengthMeters: 9,
    weightKg: 4000,
    discoveryLocation: "Montana, USA"
  },
  {
    ...
    size: "Large",
    habitat: "River valleys",
    traits: ["Neck spines", "Shorter neck", "Sound production", "Unique sauropod"],
    description: "Unusual sauropod with distinctive neck spines",
    lengthMeters: 12,
    weightKg: 8000,
    discoveryLocation: "Argentina"
  },
  {
    ...
    traits: ["Back sail", "Arm quills", "Crested skull", "Unique predator"],
    description: "Spanish predator with a distinctive back sail",
    lengthMeters: 6,
    weightKg: 400,
  ...
  },
  {
    ...
    traits: ["Heavy armor", "Camouflage coloring", "Marine environment", "Well-preserved"],
    description: "Heavily armored herbivore with preserved original coloring",
    lengthMeters: 5.5,
    weightKg: 1300,
    discoveryLocation: "Alberta, Canada"
  },

  // Additional Small/Unique Species
  {
    id: "epidexipteryx",
    name: "Epidexipteryx",
    scientificName: "Epidexipteryx hui",
    period: "Middle Jurassic",
    era: "Mesozoic",
    diet: "Insectivore",
    size: "Tiny",
    habitat: "Forests",
    traits: ["Display feathers", "No flight", "Arboreal", "Primitive bird-like"],
    description: "Small feathered dinosaur with elaborate tail plumes",
    lengthMeters: 0.4,
    weightKg: 0.2,
    discoveryLocation: "China"
  },
  {
    ...
    diet: "Piscivore",
    size: "Large",
    habitat: "Rivers and coastlines",
    traits: ["Fish-eater", "Crocodile-like skull", "Semi-aquatic", "Spinosaur family"],
    description: "Brazilian fish-eating dinosaur related to Spinosaurus",
    lengthMeters: 8,
    weightKg: 1000,
    discoveryLocation: "Brazil"
  },
  {
    id: "kosmoceratops",
    name: "Kosmoceratops",
    ...
    traits: ["Elaborate frill", "15 horns", "Ornate skull", "Display features"],
    description: "The most ornate-skulled dinosaur ever discovered",
    lengthMeters: 4.5,
    weightKg: 1200,
    discoveryLocation: "Utah, USA"
  }
