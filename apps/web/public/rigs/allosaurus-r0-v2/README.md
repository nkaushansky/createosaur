# Createosaur R0 Allosaurus Layer Pack v2
...
Supersedes `allosaurus-r0-v1`: the master now paints a partially open mouth
...
- Pattern masks are seeded stage-aligned fields clipped per layer
  (seed 20260720 — the same Allosaurus individual as v1).
